          ...
          {session && (
            ...
            >
              ...
              {session.permissions.includes("members.manage") && (
                <Link href="/settings/members" className="hover:text-cyan-300">
                  Members
                </Link>
              )}
            </nav>
        ...
        {session && (
          <div className="flex items-center gap-3">
            ...
            <form action={logoutAction}>
              <button className="rounded-full border border-slate-700 px-3 py-1 text-xs text-slate-300 hover:border-red-500/50 hover:text-red-200">
                Sign out
              </button>
            </form>
          </div>
